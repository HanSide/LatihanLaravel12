...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
  <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          <li>  
<x-admin.sidelink href="/adminsubject" :active="request()->is('adminsubject')">Subject</x-admin.sidelink>
          </li>
          <li>
<x-admin.sidelink href="/adminguardian" :active="request()->is('adminguardian')">Guardian</x-admin.sidelink>
          </li>
          <li>
<x-admin.sidelink href="/adminclassroom" :active="request()->is('adminclassroom')">Classroom</x-admin.sidelink>
          </li>
           <li>
<x-admin.sidelink href="/adminstudent" :active="request()->is('adminstudent')">Student</x-admin.sidelink>
          </li>
          <li>
